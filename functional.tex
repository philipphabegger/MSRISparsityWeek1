...
\begin{proof}
  ...
  Conversely, if $x\in V^{\circ}$, then there exists an abelian
  subvariety $B\subset A$ with $x+B \subset V$ and $\dim B \ge 1$. The
...
\end{theorem}
\begin{proof}
  See Theorems 1 and 2~\cite{abramovich} for (i) and (ii). 
\end{proof}
...
\begin{proof}
  ...
  $V^{\circ}$. The converse direction is easier, indeed, any coset of
